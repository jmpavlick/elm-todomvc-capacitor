...
To fix this, we're going to wire in some of Capacitor's platform hooks, so that we can give our Elm application more information about its runtime environment.
